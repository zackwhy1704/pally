          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(l10n.homeEmptySetupFirst(l10n.mascotName),
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    Text(l10n.homeEmptyNoMochis(l10n.mascotName),
                        style: AppTextStyles.heading1.copyWith(fontSize: 22),
                        textAlign: TextAlign.center),
                    const SizedBox(height: AppSpacing.sm),
                    Text(l10n.homeEmptyCreate(l10n.mascotName),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Text(l10n.homeEmptyCreateButton(l10n.mascotName),
